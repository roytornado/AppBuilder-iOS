...
static NSMutableArray *langMainList = nil;
...
+ (void)buildLangDict
{
    ...
    if (!langMainList)
    {
        langMainList = [NSMutableArray arrayWithObjects:@"zh-Hant", @"en", @"zh-Hans", @"zh-TW", nil];
    }
    dictionary = [NSMutableDictionary dictionary];

    for (NSString *lang in langMainList)
    {
...
+ (void)addLang:(NSString *)newLang
{
    ...
    [langMainList addObject:newLang];
    [App buildLangDict];
}
